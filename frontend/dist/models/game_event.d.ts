...
export declare const isTournament: (gameEvent: GameEvent) => gameEvent is Readonly<_GameEventTournament>;
export declare const isLeague: (gameEvent: GameEvent) => gameEvent is Readonly<_GameEventLeague>;
